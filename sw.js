...
const urlsToCache = [
  ...
  '/tulipsalon/admin.html',
  '/tulipsalon/admin-login.html',
  '/tulipsalon/calendar.html',
  '/tulipsalon/setup-wizard.html',
  '/tulipsalon/editar-negocio.html',
  '/tulipsalon/manifest.json',
  '/tulipsalon/icons/icon-72x72.png',
  '/tulipsalon/icons/icon-96x96.png',
  '/tulipsalon/icons/icon-128x128.png',
  '/tulipsalon/icons/icon-144x144.png',
  ...
  '/tulipsalon/utils/push-config.js',
  '/tulipsalon/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/tulipsalon/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/tulipsalon/icons/icon-192x192.png',
    badge: '/tulipsalon/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/tulipsalon/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/tulipsalon/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Tulip Salón ');
